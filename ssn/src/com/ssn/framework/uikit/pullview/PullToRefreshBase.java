 ...
 *******************************************************************************/
package com.ssn.framework.uikit.pullview;
...
import com.ssn.framework.uikit.pullview.internal.*;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private boolean keepLoadingLayoutScrollWhenTouchUp = true;//手指松开之后是否保持滑动到Header或footer的内容
	...
	/**
	 * @return Either {@link com.ssn.framework.uikit.pullview.PullToRefreshBase.Orientation#VERTICAL} or
	 *         {@link com.ssn.framework.uikit.pullview.PullToRefreshBase.Orientation#HORIZONTAL} depending on the scroll direction.
	 */
	...
	protected BaseLoadingLayout createLoadingLayout(Context context, Mode mode, TypedArray attrs) {
		BaseLoadingLayout layout = mLoadingAnimationStyle.createLoadingLayout(context, mode,
	 ...
	 * {@link com.ssn.framework.uikit.pullview.PullToRefreshBase.State#PULL_TO_REFRESH} state.
	 */
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {@link com.ssn.framework.uikit.pullview.PullToRefreshBase.State#REFRESHING} or {@link com.ssn.framework.uikit.pullview.PullToRefreshBase.State#MANUAL_REFRESHING} state.
	 *
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {@link com.ssn.framework.uikit.pullview.PullToRefreshBase.State#RELEASE_TO_REFRESH} state.
	 */
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {@link com.ssn.framework.uikit.pullview.PullToRefreshBase.State#RESET} state.
	 */
	...
	public interface PullToRefreshHeaderScrollListener{
		/**
		 * @param value headerVisiblePartHeight
		 */
		public void onHeaderScroll(int value);
	}

	private PullToRefreshHeaderScrollListener headerScrollListener;

	public PullToRefreshHeaderScrollListener getHeaderScrollListener() {
		return headerScrollListener;
	}

	public void setHeaderScrollListener(PullToRefreshHeaderScrollListener headerScrollListener) {
	...
	protected final void setHeaderScroll(int value) {
		...
		if (headerScrollListener != null){
			headerScrollListener.onHeaderScroll(value);
		}
	...
	public static enum AnimationStyle {
		...
		BaseLoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
			switch (this) {
				...
				case FISH:
					return new FishLoadingLayout(context, mode, scrollDirection, attrs);
			}
		}
	}
	...
	public static enum Mode {
		 ...
		 * {@link com.ssn.framework.uikit.pullview.PullToRefreshBase#setRefreshing() setRefreshing()}.
		 */
	...
	public static interface OnPullEventListener<V extends View> {
		 ...
		 * @param direction - One of {@link com.ssn.framework.uikit.pullview.PullToRefreshBase.Mode#PULL_FROM_START} or
		 *            {@link com.ssn.framework.uikit.pullview.PullToRefreshBase.Mode#PULL_FROM_END} depending on which direction
		 *            the user is pulling. Only useful when <var>state</var> is
		 *            {@link com.ssn.framework.uikit.pullview.PullToRefreshBase.State#PULL_TO_REFRESH} or
		 *            {@link com.ssn.framework.uikit.pullview.PullToRefreshBase.State#RELEASE_TO_REFRESH}.
		 */
	...
	public void setHeaderLabels(String pullLabel,String refreshingLabel,String releaseLabel){
		mHeaderLayout.setLabels(pullLabel, refreshingLabel, releaseLabel);
	}

	public void setFooterLabels(String pullLabel,String refreshingLabel,String releaseLabel){
		mFooterLayout.setLabels(pullLabel, refreshingLabel, releaseLabel);
	}

	/**
	 * 头部是否隐藏副标题文档,只对有副标题的Header才有效
	 * @param contain
	 */
	public void setHeaderContainSubText(boolean contain){
		if (mHeaderLayout instanceof LoadingLayout){
			((LoadingLayout) mHeaderLayout).setLayoutWithSubText(contain);
		}
	}

	public boolean isKeepLoadingLayoutScrollWhenTouchUp() {
		return keepLoadingLayoutScrollWhenTouchUp;
	}

	public void setKeepLoadingLayoutScrollWhenTouchUp(boolean keepLoadingLayoutScrollWhenTouchUp) {
		this.keepLoadingLayoutScrollWhenTouchUp = keepLoadingLayoutScrollWhenTouchUp;
	}
