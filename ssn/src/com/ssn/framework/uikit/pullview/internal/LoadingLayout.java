...
//	protected final ImageView fish_icon;//小章鱼icon
//	protected final ImageView refresh_tip_icon;//只卖正品，顺丰直营
...
//				fish_icon.setVisibility(GONE);
//				refresh_tip_icon.setVisibility(GONE);
...
//		if (View.VISIBLE == fish_icon.getVisibility()) {
//			fish_icon.setVisibility(View.INVISIBLE);
//		}
//		if (View.VISIBLE == refresh_tip_icon.getVisibility()) {
//			refresh_tip_icon.setVisibility(View.INVISIBLE);
//		}
	}
...
//		if (View.INVISIBLE == fish_icon.getVisibility()) {
//			fish_icon.setVisibility(View.VISIBLE);
//		}
//		if (View.INVISIBLE == refresh_tip_icon.getVisibility()) {
//			refresh_tip_icon.setVisibility(View.VISIBLE);
//		}
	}
...
//				mSubHeaderText.setVisibility(View.GONE);
	...
	public void setLayoutWithSubText(boolean withIn){
		int visible = withIn ? View.VISIBLE : View.GONE;
...
//			APPLog.info("setFishIconSize width = " + _width + " height = " + _height);
